...
**Active phase:** **Phase 4.7 Layer 2 COMPLETE + HP stat shipped (2026-04-25) — HP funnel replaces per-stat death watch. Drives at 0 drain HP (-15/-20/-10/-10), regen +1/h when thriving (needs ≥60, bladder ≤40, sickness <30, awake). Verified: drain rate matches spec, death+respawn pipeline, regen 50→54 over 1.5gh. Layer 3 (Momentum) + life-goal satisfaction/completion pending.**
